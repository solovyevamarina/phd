...
for cik in comp_list['CIK']:
    ...
    for filing in list_10q:
        ...
        t1_se = find_index(part_1_financial_info, t1_s, t1_e)
        ...
        path_table1 = str('C:/Users/Marina/Documents/PhD/Data/Financials/' + comp_ticker + '_t1.csv')
        comp_t1.to_csv(path_table1, index=False)

        # Table 2: Consolidated Balance Sheets
        t2_se = find_index(part_1_financial_info, t2_s, t2_e)
        ...
        path_table2 = str('C:/Users/Marina/Documents/PhD/Data/Financials/' + comp_ticker + '_t2.csv')
        ...
        path_table3 = str('C:/Users/Marina/Documents/PhD/Data/Financials/' + comp_ticker + '_t3.csv')
